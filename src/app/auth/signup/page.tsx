        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={role} onValueChange={(value: "EMPLOYEE" | "ADMIN") => setRole(value)} disabled={isLoading}>
                <SelectTrigger id="role" className="mt-1 bg-black/30 border-slate-700/50 text-slate-300 placeholder:text-slate-500 focus:border-violet-500/50">

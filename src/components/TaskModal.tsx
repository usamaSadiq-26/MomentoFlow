            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select value={type} onValueChange={(value: any) => setType(value)}>
                  <SelectTrigger id="type" className="mt-1 bg-slate-900/50 border-white/10 text-slate-200">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div>
                ...
                >
                  <SelectTrigger id="priority" className="mt-1 bg-slate-900/50 border-white/10 text-slate-200">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="bg-slate-900 border-white/10 text-slate-200">
                    {PRIORITIES.map((p) => (
          ...
          <div className="grid grid-cols-2 gap-4">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    className={cn(
                      'w-full mt-1 justify-start text-left font-normal bg-slate-900/50 border-white/10 text-slate-300',
            ...
            <div>
              ...
              <Select value={assignee} onValueChange={setAssignee}>
                <SelectTrigger id="assignee" className="mt-1 bg-slate-900/50 border-white/10 text-slate-200">
            ...
            {attachments.length > 0 && (
              <div className="mt-2 space-y-2 max-h-32 overflow-y-auto">
                {attachments.map((attachment: any) => (
                  <div key={attachment.id} className="flex items-center gap-2 p-2 bg-slate-900/50 rounded-lg border border-white/10">
